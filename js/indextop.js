$(() => {
            ...
            <li class="nav-li nav-daohang">
                ...
                <ul class="daohang">
                    ...
                    <li>
                        <i>商城特色</i>
                        <p>
                            <a href="./html/list.html?search=telve" >ULED新品上市</a>
                            <a href="./html/list.html?search=air" target="_block">科龙专区</a>
                            <a href="./html/list.html?search=ice" target="_block">容声专区</a>
                        </p>
                    </li>
                </ul>
            </li>
        ...
        nav.on('mouseover', function(e) {
            ...
            if (eparent.hasClass('nav-hover')) {
                if (eparent.attr('index') != searchUrl) {
                    ...
                    // 跳转详情页
                    //  '_blank'
                    open(`./html/list.html?search=${eparent.attr('index')}`, '_self');

                } else {
                    window.open(`./html/list.html?search=${eparent.attr('index')}`, '_self')
                }
    ...
    function render(jie, classn) {
        ...
        for (let i = 0; i < jie[classn][0].length; i++) {
            ...
            str1 += `<li>
                <a href="./html/list.html?search=${classn}"><img src="${listMainImage}" alt="">
                    <p>${name}</p>
                    <span>￥ ${price}</span></a>
            </li>`
        }
        ...
        if (dataa.length == 2) {
            ...
            for (let i = 0; i < jie[classn][1].length; i++) {
                ...
                str2 += `<li>
                <a href="./html/list.html?search=${classn}" ><img src="${url1}" alt="" ><span>${name}</span></a>
            </li>`
            }
            str2 += ` <li class=" mainnav-last">
            <a href="./html/list.html?search=${classn}" ><span>进入频道</span><i class="iconfont  icon-icon-test7"></i></a>
        </li>`;
            navLe.html(str2);
            ...
            for (let i = 0; i < dataa.length; i++) {
                ...
                str2 += `<li>
                <a href="./html/list.html?search=${classn}" ><img src="${url1}" alt=""><span>${name1}</span></a>
            </li>`
            }
            str2 += ` <li class=" mainnav-last">
                <a href="./html/list.html?search=${classn}" ><img src="${url1}" alt=""><span>${name1}</span></a>
